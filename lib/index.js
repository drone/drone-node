...
class Client {
   ...
   * Ref: https://github.com/harness/drone/blob/v2.11.1/handler/api/repos/all.go#L30
   */
   ...
   * @param {integer} page Page number
   * @param {integer} limit Page limit
   * Ref: https://github.com/harness/drone/blob/v2.11.1/handler/api/repos/builds/list.go#L37
   */
