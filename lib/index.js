...
class Client {
  ...
  /**
   * Incomplete builds
   * Ref: https://github.com/harness/drone/blob/v2.11.1/handler/api/builds/builds.go
   */
  incompleteBuilds () {
    return this._axios.get(
   ...
   * Ref: https://github.com/harness/drone/blob/v2.11.1/handler/api/repos/builds/purge.go
   */
   ...
   * Ref: https://github.com/harness/drone/blob/v2.11.1/handler/api/repos/builds/find.go
   */
   ...
   * Ref: https://github.com/harness/drone/blob/v2.11.1/handler/api/repos/builds/retry.go
   */
   ...
   * @param {string} repo Name of the repo
   * @param {integer} number Number of the build
   * Ref: https://github.com/harness/drone/blob/v2.11.1/handler/api/repos/builds/cancel.go
   */
   ...
   * Ref: https://github.com/harness/drone/blob/v2.11.1/handler/api/repos/builds/promote.go
   */
